...
### 14.11 2025-12-11/12 審計報告修復 (v1.1.1)

> 📄 來源: `MVP_Audit_Report-1211.md`, `MVP_Audit_Report-1212.md`

#### 技術審計發現

| 分類    | 問題                              | 狀態                   |
| ------- | --------------------------------- | ---------------------- |
| 🔴 資料 | Notes.category_id 未被 CRUD 寫入  | ✅ 已修復 (2025-12-11) |
| 🔴 資料 | Foreign Keys 未正確啟用           | ✅ 已修復 (2025-12-12) |
| 🔴 資料 | Schema 雙重事實 (LEFT JOIN 修復)  | ✅ 已修復 (2025-12-12) |
...
| 分類  | 問題                          | 狀態                   |
| ----- | ----------------------------- | ---------------------- |
| 🔴 UX | Prompt Builder 錯誤狀態死胡同 | ✅ 已修復 (2025-12-11) |
| 🔴 UX | 搜尋無結果誤導為「無資料」    | ✅ 已修復 (2025-12-11) |
| 🔴 UX | 手機版側邊欄過濾後遮擋結果    | ✅ 已修復 (2025-12-11) |
| 🟡 UX | Quick Add / New Note 競爭     | 可選 (v1.2)            |
| 🟡 UX | Markdown WYSIWYG 門檻         | 延後 (v2.0)            |
