...
- This does not mean live/default notes, taxonomy, or files ownership has changed. This update did not deploy Pi, edit Caddy/systemd, change frontend defaults, touch production DB/files, remove Python, or claim raw/binary attachment serving, uploads, import/export, server/system, or cleanup ownership.
