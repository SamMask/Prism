...
`23.8.2 Local smoke artifact` is the next recommended packaging step. `23.8-thumb.1 Go WebP encoder dependency decision` is the next thumbnail-specific planning gate before any Pillow removal.
