...
- This does not mean live/default notes, taxonomy, files, uploads, or cleanup ownership has changed. This update did not deploy Pi, edit Caddy/systemd, change frontend defaults, touch production DB/files, remove Python, or claim import/export, server/system, live migration runner, or full Go-primary ownership.
