...
- This does not mean live/default notes, taxonomy, files, uploads, cleanup, or import/export ownership has changed. This update did not deploy Pi, edit Caddy/systemd, change frontend defaults, touch production DB/files, remove Python, or claim server/system, live migration runner, or full Go-primary ownership.
