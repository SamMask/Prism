...
def test_go_thumbnail_candidate_source_is_flag_gated_and_query_only_safe():
    ...
    assert "sqliteQueryOnly:          !(enableTagWrite || enableCategoryWrite || enableNotesWrite || enableAttachmentWrite || enableMediaCleanup || enableImportExport || enableServerSystem)" in main_go
