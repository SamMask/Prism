...
- 驗收：大量長文 fixture 下 list preview 不含全文 tail、detail 仍回全文、tail token 搜尋命中不退化；targeted Go / static regression、frontend build 與 Loop gate 已通過。
